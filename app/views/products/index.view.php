...
<script>
  window.app.resourceName = 'admin/san-pham';
    ...
    <?php foreach ($products as $product) { ?>
      <tr id="row_<?php echo $product['id']; ?>">
        ...
        <td class="text-center">
          <i class="action-edit fa fa-pencil" data-action-id="<?php echo $product['id']; ?>"></i>
        ...
        <div class="modal-body p-4">
          <div class="form-row">
            <div class="form-group col-lg-12">
              ...
              <img src="" id="photo_uploaded" style="width: 100%; height: auto;">
            </div>
          </div>
